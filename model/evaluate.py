...
# def get_topk_results(predictions, scores, targets, k, all_items=None, tokenizer=None):
#     results = []
#     B = len(targets)
#     targets = tokenizer.batch_encode_plus(targets)['input_ids']
...
#         one_results = []
#         for sorted_pred in sorted_pairs:
#             if set(sorted_pred[0]) == set(target_item):
#                 one_results.append(1)
#                 break
#             else:
#                 one_results.append(0)
#
#         one_results = one_results + [0] * (len(sorted_pairs) - len(one_results))
#         results.append(one_results)
#     return results
